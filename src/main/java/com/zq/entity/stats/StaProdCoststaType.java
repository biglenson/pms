...
@Table(name="sta_prod_coststa_type")
public class StaProdCoststaType implements Serializable {
	/** 
	* <p>Title: </p> 
	* <p>Description: </p> 
	* @date 2017年7月21日 上午8:23:17 
	*/
	private static final long serialVersionUID = -3346478636365512798L;

	public StaProdCoststaType() {
	}
	
	@Column(name="id", nullable=false, length=10)	
	@Id	
	@GeneratedValue(generator="STAPRODCOSTSTATYPE_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="STAPRODCOSTSTATYPE_ID_GENERATOR", strategy="native")	
	private int id;
