...
@Table(name="bas_capex_transferplan")
public class BasCAPEXTransferplan implements Serializable {
	/** 
	* <p>Title: </p> 
	* <p>Description: </p> 
	* @date 2017年7月11日 下午4:16:32 
	*/
	private static final long serialVersionUID = 8445849196042897858L;

	public BasCAPEXTransferplan() {
	}
	
	@Column(name="id", nullable=false, length=10)	
	@Id	
	@GeneratedValue(generator="BAS_CAPEX_TRANSFERPLAN_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="BAS_CAPEX_TRANSFERPLAN_ID_GENERATOR", strategy="native")	
	private int id;
