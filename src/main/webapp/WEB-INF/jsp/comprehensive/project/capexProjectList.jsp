...
<div id="listDIV" class="tabContent"> 
 	<table border="0" cellpadding="0" cellspacing="0" class="listTable" id="entryTable">
		...
		<tbody>
			<%
			    FormBaseResove.prepareForFormList(user, dataList, request);
			...
			%>
				<tr class='listTableTR'>
					<td align="center" class='linkURL' onclick='openCAPEXMain(<%=capexProject.getId()%>)'><div style='text-align: center;'><%=TypeUtils.htmlEncoder(capexProject.getTitle())%></div></td>
