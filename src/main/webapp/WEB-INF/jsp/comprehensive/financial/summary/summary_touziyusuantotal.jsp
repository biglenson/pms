...
%>
	...
	%>
		<div style='float:left;height:100%;width:<%=capexPercent%>%;background-color:#0ACC4B;''></div>
		<div style='float:left;height:100%;width:<%=opexPercent%>%;background-color:#fe902c;''></div>
	</div>
	<div style='width:90%;margin:10px auto;'>
		<table style='width:100%;'>
			<tr>
				<td width="50%" class='tipSpan' style="text-align: center;border-right:#E8E9ED solid 1px;padding-left: 5px;"><span>CAPEX</span><br><span class="tipSpan2"><%=TypeUtils.double2String(capexMoney)%></span></td>
				<td width="50%" class='tipSpan' style="text-align: center;padding-left: 5px;"><span>OPEX</span><br><span class="tipSpan2"><%=TypeUtils.double2String(opexMoney)%></span></td>
			</tr>
		</table>						
	</div>
