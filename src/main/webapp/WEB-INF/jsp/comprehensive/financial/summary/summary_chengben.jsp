...
<div class="sumValue"
	style="color:<%=(totalActualCostValue>totalPlanCostValue)?"#BF100F":"#0ACC4B" %>">
...
<div
	...
	<div
		style=' height:100%;width:<%=totalPlanCostValue!=0?percent.intValue()>100?100:percent.intValue():0%>%;background-color:<%=(totalActualCostValue>totalPlanCostValue)?"#BF100F":"#0ACC4B" %>;''></div>
</div>
<div style='width: 90%; margin: 5px auto;'>
	<table style='width: 100%;'>
		...
		<tr>
			<td class='tipSpan' style="text-align: left;"><span>
					完成比例&nbsp;:</span></td>
