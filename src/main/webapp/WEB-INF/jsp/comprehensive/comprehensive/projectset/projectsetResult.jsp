...
%>
<div style="margin:10px auto;max-height:250px;overflow : auto;" id="projectsetDIV">
	<table id="projectSetResultTable" class="listTable"  cellpadding="0" cellspacing="0" border="0">
		<thead>
			<tr>
		...
		<tbody>
			<%for(CMCCItemSet s:itemSet){ %>
				<tr>
					<td align="center"><div class="nowrapText linkURL" onclick="openItemSet(<%=s.getId()%>)" style="width: 200px;" title="<%=TypeUtils.xmlEncoderForIE(s.getTitle())%>"><%=TypeUtils.xmlEncoderForIE(s.getTitle())%></div></td>
					...
					<td>
					 ...
					 -->
					<td align="center"><div style='width:110px;padding-right:10px;' class="nowrapText"><%=opexDouble!=null? TypeUtils.formatWanMoney(opexDouble, ""):"0"%></div></td>
					<td align="center"><div style='width:110px;padding-right:10px;' class="nowrapText"><%=kaizhDouble!=null? TypeUtils.formatWanMoney(kaizhDouble, ""):"0"%></div></td>
					<td align="center"><div style='width:110px;padding-right:10px;' class="nowrapText"><%=zhuanziDouble!=null? TypeUtils.formatWanMoney(zhuanziDouble, ""):"0"%></div></td>
