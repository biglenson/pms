	...
	<div style="width: 190px; margin-left: 10px; float: left">
		<div style="margin-top: 8px;">
			...
			<div
				...
				<div
					style=' height:100%;width:<%=capexValue!=0? (shiYongValue>capexValue?100:shiYongValue/capexValue*100):0%>%;background-color:#0ACC4B'></div>
			</div>
			<div style="padding-bottom: 18px; border-bottom: 1px solid #EBE8EF;">
				投资计划总额&nbsp;: <b style="font-size: 14px;"><%=TypeUtils.formatWanMoney(capexValue,"")  %></b>
			</div>
		</div>
		...
		<div style="margin-top: 15px;">
			...
			<div
				style="padding-bottom: 10px; font-size: 16px; font-weight: bold;"><%=TypeUtils.formatWanMoney(ziJinShiYongValue,"") %></div>
			<div
				style='width: 95%; margin: 10px auto; height: 8px; background-color: #E8E9ED;'>
				<div
					style=' height:100%;width:<%=ziJinValue!=0?(ziJinShiYongValue>ziJinValue?100: ziJinShiYongValue/ziJinValue*100):0%>%;background-color:#0ACC4B'></div>
			</div>
			<div style="padding-bottom: 8px;">
				自主资金池总额&nbsp;: <b style="font-size: 14px;"><%=TypeUtils.formatWanMoney(ziJinValue,"")  %></b>
			</div>
		</div>
	</div>
	<div id="touziDetialCapexDepartDIV" style="margin-left: 220px;">
		<div style="height: 250px;">
			<table id="touziDetialCapexDepartDIVTable" class="listTable"
				...
				%>
					<tr>
						<td align="center" class="linkURL"
							onclick="openDepartmentView(<%=role.getId()%>)"><div><%=TypeUtils.xmlEncoderForIE(role.getName()) %></div></td>
