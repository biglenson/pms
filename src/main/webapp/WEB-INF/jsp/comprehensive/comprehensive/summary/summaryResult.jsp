			...
			<tr>
				<td align="right">
					<div style="margin-top: 10px; line-height: 22px; float: right;">
						<div
							style='height: 10px; width: 10px; display: inline-block; background-color: #09CC4A' />
						&nbsp;&nbsp;实际完成&nbsp;:
					</div>
				</td>
			</tr>
			<tr>
				<td align="right"><b style="font-size: 14px;"><%=TypeUtils.formatWanMoney(shouRu)%></b>
				</td>
			</tr>
			<tr>
				<td align="right"><b style="font-size: 14px;"><%=perDouble!=null?TypeUtils.double2String(perDouble):"0.00" %>%</b>
				</td>
			</tr>
		</table>
	</div>
...
<div style="height: 160px; padding-top: 10px;">
	...
	<div style="margin-left: 142px; margin-top: 20px;">
		<table style="width: 90%">
			...
			<tr>
				<td align="right"><b
					style="font-size: 14px; line-height: 22px;"><%=TypeUtils.formatWanMoney(capexValue)%></b>
				</td>
			</tr>
			<tr>
				<td align="right">
			...
			<tr>
				<td align="right"><b
					style="font-size: 14px; line-height: 22px;"><%=TypeUtils.formatWanMoney(opexValue)%></b>
				</td>
			</tr>
		</table>
	</div>
...
<div style='width: 90%; margin: 0 auto; position: relative;'>
	...
	<div class="helpFloatDIV" id="showSummaryShouRuTipDIV"
		style="line-height: 22px; max-width: 700px;">
		<div class="showHelpeContent" style="line-height: 23px;">
			<div>
	...
	<div
		style='font-size: 16px; text-align: center; padding: 3px; font-weight: bold;'><%=TypeUtils.formatWanMoney(shouRu) %></div>
	<div
		style='width: 95%; margin: 3px auto; height: 8px; background-color: #E8E9ED;'>
		<div
			style=' height:100%;width:<%=perDouble!=null?(perDouble<100?perDouble:100):"0"%>%;background-color:#0ACC4B'></div>
	</div>
	<table style="width: 98%">
		<tr>
			<td width="45%">计划&nbsp;:&nbsp;</td>
			<td width="55%" align="right"><b style="font-size: 14px;"><%=TypeUtils.formatWanMoney(target) %>
			</b></td>
		</tr>
		<tr>
			<td width="45%">完成比例&nbsp;:&nbsp;</td>
			<td align="right"><b style="font-size: 14px;"><%=perDouble!=null?TypeUtils.double2String(perDouble):"0.00" %>%</b></td>
		</tr>
		<tr>
			<td colspan="2"><div style="border-bottom: 1px solid #EBE8EF" /></td>
		</tr>
		<%for(int i=0,j=typeList.size();i<j&&i<4;i++){ 
			...
			%>
		<tr>
			<td width="45%"><%=TypeUtils.xmlEncoderForIE(c.getName()) %>:</td>
			<td align="right"><b style="font-size: 14px;"><%=v!=null?TypeUtils.formatWanMoney(v, TypeUtils.MONEY_P)+"":"0"%>
			</b></td>
		</tr>
		<%} %>
	</table>
...
<div style="height: 160px; padding-top: 10px; position: relative;">
	...
	<div style="margin-left: 142px; margin-top: 20px;">
		<table style="width: 90%">
			...
			<tr>
				<td align="right">新建&nbsp;<b
					style="font-size: 14px; line-height: 22px;"><%=capexCount%></b>&nbsp;项
				</td>
			</tr>
			<tr>
				<td align="right">
			...
			<tr>
				<td align="right">全部&nbsp;<b
					style="font-size: 14px; line-height: 22px;"><%=opexCount%></b>&nbsp;项
				</td>
			</tr>
		</table>
	</div>
...
<div style="width: 95%; margin: 0px auto;">
	<div style="padding-top: 10px;">
		...
		<div style="width: 100%; text-align: right;">
			<b style="font-size: 20px;"><%=TypeUtils.formatNumber(capexPercent, 2) %>%</b>
		</div>
		<div
			style='width: 100%; height: 8px; background-color: #E8E9ED; margin: 10px auto;'>
			<div
				style='height:100%;width:<%=capexPercent%>%;background-color:#0ACC4B;''></div>
		</div>
		...
		<div style="width: 100%; text-align: right;">
			<b style="font-size: 20px;"><%=TypeUtils.formatNumber(opexPercent, 2) %>%</b>
		</div>
		<div
			style='width: 100%; height: 8px; background-color: #E8E9ED; margin: 10px auto;'>
			<div
				style='height:100%;width:<%=opexPercent%>%;background-color:#0ACC4B;'></div>
		</div>
	</div>
</div>
<jsp:include page="/WEB-INF/jsp/common/viewChangeTime.jsp">
...
<div style="width: 94%; margin: 0px auto; height: 100%">
	...
	<table style="width: 100%; height: 100%">
		<tr>
			...
			<td width="40%" align="right"><b style="font-size: 14px;"><%=TypeUtils.formatWanMoney(kaizhiActual) %></b>
			</td>
		</tr>
		...
		<tr>
			...
			<td align="right"><b style="font-size: 14px;"><%=TypeUtils.formatWanMoney(opexActual) %></b>
			</td>
		</tr>
		<tr>
			<td>
				<div style='height: 8px; background-color: #E8E9ED;'>
					<div
						style='height:100%;width:<%=opexPerCenter%>%;background-color:#0ACC4B;''></div>
				</div>
			</td>
			<td align="right">
				<div style="color: #0ACC4B;">
