		...
		<tbody>
			...
			<tr>
				<td><div
						...
						class="nowrapText linkURL"
						title="<%=TypeUtils.xmlEncoderForIE(t.getTitle()) %>"
						onclick="openProduct(<%=t.getId()%>)"><%=TypeUtils.xmlEncoderForIE(t.getTitle()) %></div></td>
				...
				<td><div style='width: 80px; text-align: center;'
						class="nowrapText"
						title="<%=TypeUtils.formatWanMoney(t_shou-t_chengBen, "")%>"><%=TypeUtils.formatWanMoney(t_shou-t_chengBen, "")%></div></td>
				<td><div style='width: 80px; text-align: center;'
						class="nowrapText"
						title="<%=TypeUtils.formatWanMoney(t_touzi, "")%>"><%=TypeUtils.formatWanMoney(t_touzi, "")%></div></td>
