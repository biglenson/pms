...
<div style="width:100%;margin:0px auto;">
	<table id="departmentResultTable" class="listTable" style=" margin:10px auto;" cellpadding="0" cellspacing="0" border="0">
		...
		<tbody>
			...
			%>
				<tr>
					<td><div style='width:90px;text-align: left;padding-left: 10px;' title="<%=TypeUtils.xmlEncoderForIE(t.getName()) %>" class="nowrapText linkURL" onclick="openDepartmentView(<%=t.getId()%>)"><%=TypeUtils.xmlEncoderForIE(t.getName()) %></div></td>
...
<jsp:include page="/WEB-INF/jsp/common/viewChangeTime.jsp">
		<jsp:param  name="lastUpdateDIV" value="productAndDepart_departTime"/>
	</jsp:include>