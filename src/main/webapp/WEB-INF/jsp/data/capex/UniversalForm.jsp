	...
	window.toogle_close_flag=false;
		...
		<div class="content-wrap" id="bodyStart__content_Wrap">
			...
			<div class="content-main">
				<form name="frm" id="capexSelfFundsPool"
					action="/capex/capexSelfFundsPool" method="post">
							...
							<tbody>
								<tr>
									<td id="ET_ToolbarButton" class="toolbarEnable" align="center"
										nowrap="">
										<div class="ET_ToolbarButtonContainer "
							...
							<c:forEach items="${recordlist}" var="record">
								<tr class="listTableTR">
									<td align="center"><img name="action-open" id="actionImg"
										src="/static/images/16x16/action_open.gif" title="快捷操作"
										style="cursor: pointer"
										onclick="javascript:showFormActionMenu(this, '285855');">
									</td>
