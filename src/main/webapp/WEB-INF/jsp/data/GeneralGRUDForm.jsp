	...
	<div class="header-box cm" id="headerDIV">
		<div class="header-down cm">
			...
			<div class="Nav cm" id="NavMenu">
				<ul>
					<li class="topon"><a href="/CMCCAction.do?operation=cmccGo&amp;menuID=81">CAPEX</a></li>
					<li><a href="/CMCCAction.do?operation=cmccGo&amp;menuID=64">OPEX</a></li>
					<li><a href="/CMCCAction.do?operation=cmccGo&amp;menuID=65">采购</a></li>
					<li><a href="/CMCCAction.do?operation=cmccGo&amp;menuID=66">数据映射</a></li>
				</ul>
		...
		<div class="topHeader_changeSysWrap">
			<table>
				<tbody>
					<tr>
						<td>
						<div class="topHeader_changeProduct " 	onclick="systemWitch(1)">
								<img src="/static/images/app/PPM.png"><div class="productName">综合视图</div>
							</div>
						</td>
						<td><div class="topHeader_changeProduct  currentProduct">
								<img src="/static/images/app/CM.png"><div class="productName">数据管理</div>
							</div>
						</td>
						<td><div class="topHeader_changeProduct " onclick="systemWitch(3)">
								<img src="/static/images/app/Admin.png"><div class="productName">系统管理</div>
							</div>
						</td>
					</tr>
				</tbody>
